...
public class EditarEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 460, 53));
        ...
        instruccionesUsuario3.setText("Ingrese el Identificador del Estudiante para realizar la Búsqueda:");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        try
        {
            ...
            Estudiante estudiante = EstructuraGeneral.buscarEstudiante(id);
             if (estudiante != null)
            {
                textoIdentificador.setText(String.valueOf(estudiante.getId()));
            ...
            {
                JOptionPane.showMessageDialog(this, "El Estudiante que busca No se encuentra registrado","Error",JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
        ...
        EstructuraGeneral.actualizarEstudiante(new Estudiante(id, nombre, direccion));
           JOptionPane.showMessageDialog(this, "Se ha actualizado Correctamente al Estudiante","Completado",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        int id = Integer.parseInt(textoIdentificador.getText());
            if (EstructuraGeneral.eliminarEstudiante(id))
            {
               JOptionPane.showMessageDialog(this, "Se ha Eliminado Correctamente al Estudiante","Completado",JOptionPane.INFORMATION_MESSAGE);
