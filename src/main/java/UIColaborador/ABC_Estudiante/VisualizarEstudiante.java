...
public class VisualizarEstudiante extends javax.swing.JFrame {
    ...
    public void llenarTabla() {
        ArrayList<Estudiante> listaEstudiantes = EstructuraGeneral.getEstudiantes();
        DefaultTableModel tabla = (DefaultTableModel) tableEstudiantes.getModel();
        ...
        for (int i = 0; i < listaEstudiantes.size(); i++)
        {
            ...
            String datos[] =
            {
                String.valueOf(estudiante.getId()),estudiante.getNombre(),estudiante.getDireccion()
            };
            tabla.addRow(datos);
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 310, 53));
        ...
        instruccionesUsuario3.setText("Estudiantes registrados en el Sistema:");
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(VisualizarEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualizarEstudiante().setVisible(true);
            }
        });
    }
